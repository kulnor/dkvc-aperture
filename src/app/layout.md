...
### Renders
`<html lang="en">` with the Geist font CSS variable and a `font-sans` class, wrapping `<body>{children}</body>`. Imports `./globals.css` (shadcn-generated Tailwind v4 tokens) once at the root.
