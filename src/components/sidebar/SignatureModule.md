...
### Renders
A small header, a table of signatures (Sig / Type / Name / TTL / delete), and an add form below. Each type cell is a `WormholeTypeSelect`. TTL is rendered as a relative duration (e.g. "23h", "2d", "expired").
...
- `expiresAt` for new sigs defaults to now + 24 h.
